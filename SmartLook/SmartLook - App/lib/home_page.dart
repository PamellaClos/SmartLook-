...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    if (AppInform.apps.isEmpty == false) {
      AppInfo app = AppInform.apps[0];
    }
    else {
      AppInform.apps.clear();
    }
      ...
      body: Column(
        children: [
          ...
          AppInform.apps.isEmpty == null
            ...
            child: ListTile(
              title: Text("Nenhum App selecionado"),
          ...
          Container(
            child: Column(
              ...
              children: [
                ...
                Text("Lista de aplicativos que estão seguros",
